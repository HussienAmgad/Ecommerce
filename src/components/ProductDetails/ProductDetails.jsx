      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-2">
          ...
          <div className="w-full md:w-1/2 px-2">
            {productDetails ? (
              <>
                <h2 className="text-2xl font-bold mb-1">{productDetails.title}</h2>
                <p className="text-gray-600 mb-2">SKU: {productDetails.sku || 'N/A'}</p>
                <div className="mb-2">
                ...
                <p className="text-md text-gray-700">{productDetails.description}</p>
                <div className="flex space-x-2 mt-4">
                  <button className="bg-indigo-600 flex gap-2 items-center text-white px-4 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-5 w-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                    </svg>
                    Add to Cart
                  </button>
                  <button className="bg-gray-200 flex gap-2 items-center text-gray-800 px-4 py-2 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-5 w-5">
